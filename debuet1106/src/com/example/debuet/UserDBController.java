...
public class UserDBController {
	...
	/** エントリ追加 */
	void doAddEntry(String name, int age,double height,double weight){
	...
	/** 特定の年齢のデータを更新 */
	void updateEntry(int targetAge, String newName, int newAge,double newHeight,double newWeight,boolean newSex ){
