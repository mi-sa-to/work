...
public class MainActivity extends Activity implements OnClickListener{
	...
	public void onClick(View v) {
		...
		case R.id.readButton:
			...
			Cursor cursor = dbc.db.query("user_table", new String[] {"date", "sex", "age" ,"height", "weight" }, null, null, null, null, null);
			cursor.moveToFirst();
			...
			for (int i = 0; i < cursor.getCount(); i++) {
				...
				sb.append(cursor.getDouble(3)).append(",");
				sb.append(cursor.getDouble(4)).append("\n");
				cursor.moveToNext();
			}
			cursor.close();
